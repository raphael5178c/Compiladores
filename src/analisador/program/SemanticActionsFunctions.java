...
public class SemanticActionsFunctions {
	...
	public static void reconheceNomePrograma() {
		// falta iniciar as pilhas
		// falta iniciar as tabelas de simbolos
		// falta iniciar a area de instrução
		// falta iniciar a area de literal
	...
	public static void reconheceFinalPrograma() {
	...
	public static void afterLiteralNaInstrucaoWriteln() {
		// TODO Falta Implementar essa ação Semântica
	}
