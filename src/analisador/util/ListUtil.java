...
public class ListUtil {
	...
	public static ArrayList<String> getSubListStartsWith(ArrayList<String> listString, String compareStarter) {
		if(ValueUtil.isEmpty(listString) || ValueUtil.isEmpty(compareStarter)) return null;
		ArrayList<String> subList = new ArrayList<String>();
		for (String palavra : listString) {
			if(!palavra.toLowerCase().startsWith(compareStarter.toLowerCase())) continue;
			subList.add(palavra);
		}
		return subList;
	}
	...
	public static String getObject(ArrayList<String> listString, String object) {
		if(ValueUtil.isEmpty(listString) || ValueUtil.isEmpty(object)) return null;
		for (String palavra : listString) {
			if(object.equalsIgnoreCase(palavra)) return palavra;
		}
		return null;
	}
	
	public static boolean contaisObject(ArrayList<String> listString, String object) {
		if(ValueUtil.isEmpty(listString) || ValueUtil.isEmpty(object)) return false;
